                ...
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="signup.php" method="post">
                            ...
                            <h6 class="text-center text-danger"><?php echo($signup_error)?></h6>
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="c_password" id="c_password" class="form-control" value="<?php echo($c_password) ?>">
                                <label for="username_err" class="text-danger"> <?php echo($c_password_err) ?></label><br>

                            </div>
                            
                            <div class="form-group" class="pt-5">
